...
{{ dbt_utils.unpivot(ref('applicant_split'), cast_to='string', exclude=['full_date','applicant_full_name','customer_id','attended_showing',
...
'apartment_seattle_1','apartment_seattle_2','apartment_seattle_3','apartment_seattle_4','apartment_seattle_5',
 ...
 'contact_source','optimal_move_in_date','date_of_birth','est_length_of_stay','have_pets',
 'neigbourhoods1','neigbourhoods2','neigbourhoods3','neigbourhoods4','neigbourhoods5','monthly_gross_salary']) }}